...
def estoque_inicial(estoque_str):
    ...
    for produto in produtos:
        ...
        item = {
            'nome': detalhes[0],
            'id': detalhes[1],
            'quantidade': int(detalhes[2]),
            'custo': float(detalhes[3]),
            'preco': float(detalhes[4])
        }
